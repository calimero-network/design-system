...
export const LinearProgress: StoryObj = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', width: '400px' }}>
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>Default Progress</Text>
        <Progress value={30} />
      </div>
      
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>With Label and Value</Text>
        <Progress value={60} label="Loading..." showValue />
      </div>
      
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>Success Variant</Text>
...
export const Sizes: StoryObj = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '400px' }}>
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>Small</Text>
        <Progress value={40} size="sm" />
      </div>
      
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>Medium</Text>
        <Progress value={60} size="md" />
      </div>
      
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>Large</Text>
...
export const Variants: StoryObj = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '400px' }}>
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>Default</Text>
        <Progress value={30} variant="default" />
      </div>
      
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>Success</Text>
        <Progress value={70} variant="success" />
      </div>
      
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>Warning</Text>
        <Progress value={50} variant="warning" />
      </div>
      
      <div>
        <Text size="sm" style={{ marginBottom: '8px' }}>Error</Text>
...
export const WithLabels: StoryObj = {
  render: () => (
    <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
      ...
      <CircularProgress value={90} label="Download Complete" variant="success" showValue />
    </div>
  ),
};
