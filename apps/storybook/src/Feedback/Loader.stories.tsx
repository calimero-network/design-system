...
import { Loader, InlineLoader, FullScreenLoader, PageLoader } from '@calimero-network/mero-ui';
...
export const FullScreenLoaderStory: Story = {
  render: (args) => (
    <div style={{ position: 'relative', height: '400px', background: 'var(--color-background-primary)', borderRadius: '8px', overflow: 'hidden' }}>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', alignItems: 'center' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <Loader variant="spinner" size="medium" color="var(--color-brand-600)" />
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        <span style={{ color: 'var(--color-neutral-300)' }}>Success:</span>
        <Loader variant="dots" size="medium" color="var(--color-semantic-success)" />
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        <span style={{ color: 'var(--color-neutral-300)' }}>Warning:</span>
        <Loader variant="pulse" size="medium" color="var(--color-semantic-warning)" />
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        <span style={{ color: 'var(--color-neutral-300)' }}>Error:</span>
        <Loader variant="spinner" size="medium" color="var(--color-semantic-error)" />
      </div>
    </div>
  ),
};
