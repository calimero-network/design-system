...
export const FormExample: Story = {
  render: () => {
    ...
    const interestSuggestions = [
      'Web Development', 'Mobile Development', 'Machine Learning', 'AI',
...
export const ColorCodedTags: Story = {
  render: () => {
    const [tags, setTags] = useState([
      { id: '1', label: 'Frontend', value: 'frontend', color: 'var(--color-brand-600)' },
      { id: '2', label: 'Backend', value: 'backend', color: 'var(--color-semantic-success)' },
      { id: '3', label: 'Database', value: 'database', color: 'var(--color-semantic-info)' },
    ]);

    const suggestions = [
      'Frontend', 'Backend', 'Database', 'DevOps', 'Mobile', 'AI/ML',
      'Design', 'Testing', 'Security', 'Cloud', 'Blockchain', 'IoT'
    ];

    return (
      <div>
        <h3 style={{ color: '#FFFFFF', marginBottom: '16px' }}>Color Coded Tags</h3>
        <TagInput
          label="Categories"
          value={tags}
          onChange={setTags}
...
export const NonRemovableTags: Story = {
  render: () => {
    ...
    const suggestions = [
      'Required', 'Optional', 'System', 'Admin', 'User', 'Guest',
      'Premium', 'Free', 'Beta', 'Stable', 'Deprecated'
    ];

    return (
      <div>
        <h3 style={{ color: '#FFFFFF', marginBottom: '16px' }}>Non-Removable Tags</h3>
        <TagInput
          label="Tag Types"
          value={tags}
          onChange={setTags}
