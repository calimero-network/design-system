  ...
  render: () => {
    ...
    return (
      <form onSubmit={handleSubmit} style={{ maxWidth: '400px' }}>
        <h3 style={{ color: '#FFFFFF', marginBottom: '20px' }}>Schedule Form</h3>
        ...
        <div style={{ marginBottom: '20px' }}>
          <TimePicker
            ...
            onChange={(time) => setFormData(prev => ({ ...prev, breakTime: time }))}
...
export const DifferentFormats: Story = {
  render: () => (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
      <div>
        <h4 style={{ color: '#FFFFFF', marginBottom: '12px' }}>12-Hour Format</h4>
        <TimePicker
          label="12-Hour Time"
          placeholder="Select time"
          format="12h"
      ...
      <div>
        <h4 style={{ color: '#FFFFFF', marginBottom: '12px' }}>24-Hour Format</h4>
        <TimePicker
          label="24-Hour Time"
          placeholder="Select time"
          format="24h"
      ...
      <div>
        <h4 style={{ color: '#FFFFFF', marginBottom: '12px' }}>30-Minute Steps</h4>
        <TimePicker
          label="Appointment Time"
          placeholder="Select time"
          step={30}
