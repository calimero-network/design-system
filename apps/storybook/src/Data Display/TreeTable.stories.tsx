  ...
  },
  {
    ...
    render: (value: string) => (
      <span style={{
        ...
        fontSize: '12px',
        fontWeight: '500',
        background: value === 'Department' ? 'var(--color-brand-600)20' : 
                   value === 'Team' ? 'var(--color-neutral-600)20' : 
                   'var(--color-background-secondary)',
        color: value === 'Department' ? 'var(--color-brand-600)' : 
               value === 'Team' ? '#FFFFFF' : 
...
export const Interactive: Story = {
  render: () => {
    ...
    const handleSelectionChange = (selectedKeys: string[], selectedNodes: any[]) => {
...
export const FileSystemExample: Story = {
  render: () => {
        ...
        render: (value: string, node: any, level: number) => (
          <div style={{ 
            ...
            <Icon 
              ...
              size="xs" 
              style={{ 
                color: node.data.type === 'folder' ? tokens.color.brand[600].value : tokens.color.neutral[400].value 
              }} 
            />
            <span>{value}</span>
          </div>
      ...
      },
      {
        ...
        render: (value: string) => (
          <span style={{
            ...
            fontSize: '12px',
            fontWeight: '500',
            background: value === 'folder' ? 'var(--color-brand-600)20' : 'var(--color-background-secondary)',
    ...
    return (
      <div>
        <h3 style={{ color: '#FFFFFF', marginBottom: '16px' }}>File System Tree</h3>
        <TreeTable
          data={fileSystemData}
          columns={fileColumns}
          searchable={true}
