...
import { Navbar, NavbarBrand, NavbarItem, NavbarMenu, NavbarToggle, Menu, MenuItem, MenuGroup, MenuDivider } from "@calimero-network/mero-ui";
...
export const Variants: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div>
        <h3 style={{ color: 'white', marginBottom: '8px', fontSize: '14px' }}>Default</h3>
      ...
      <div>
        <h3 style={{ color: 'white', marginBottom: '8px', fontSize: '14px' }}>Minimal</h3>
      ...
      <div>
        <h3 style={{ color: 'white', marginBottom: '8px', fontSize: '14px' }}>Elevated</h3>
...
export const FixedNavbar: Story = {
  render: () => (
    <div style={{ height: '200vh', background: 'linear-gradient(45deg, #1A1A1A, #2A2A2A)' }}>
