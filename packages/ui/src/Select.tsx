  ...
  return (
    <div className={className} style={style}>
      {label && (
        ...
        >
          {label}
          {required && <span style={{ color: 'var(--color-semantic-error)', marginLeft: '2px' }}>*</span>}
        </label>
      )}
      {description && (
        <div
            ...
            {options.map((option, index) => (
              ...
              >
                ...
                {option.value === currentValue && (
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-brand-600)" strokeWidth="2">
