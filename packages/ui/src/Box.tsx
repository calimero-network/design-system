...
export interface BoxProps {
  ...
  backgroundColor?: 'primary' | 'secondary' | 'muted' | 'subtle' | 'transparent';
  borderRadius?: 'none' | 'sm' | 'md' | 'lg' | 'full';
  border?: 'none' | 'thin' | 'medium' | 'thick';
  borderColor?: 'default' | 'muted' | 'subtle' | 'primary' | 'success' | 'warning' | 'error';
...
export const Box: React.FC<BoxProps> = ({
  ...
  const boxStyle = {
    ...
    border: border !== 'none' ? `${borderMap[border]} ${borderColorMap[borderColor]}` : 'none',
